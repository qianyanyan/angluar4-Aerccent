...
@Component({
    selector:'mode-resuoult-tips',
    templateUrl:'./mode-resuoult-tips.component.html',
    styleUrls:['./mode-resuoult-tips.component.less'],
    providers: [deployService]
})

export class ModetipsresouleComponent implements OnInit, OnDestroy {
