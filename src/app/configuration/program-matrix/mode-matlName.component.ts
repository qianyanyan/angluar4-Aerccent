...
@Component({
    selector:'mode-matlName',
    templateUrl:'./mode-matlName.component.html',
    styleUrls:['./mode-matlName.component.less'],
    providers: [deployService]
})

export class ModeMatlnameComponent implements OnInit, OnDestroy {
