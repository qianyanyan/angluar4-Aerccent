...
@Component({
    selector:'modemodeTipPanel',
    templateUrl:'./modeTipPanel.component.html',
    styleUrls:['./modeTipPanel.component.less'],
    providers: [deployService]
})

export class ModetipsPanelComponent implements OnInit, OnDestroy {
