...
@Component({
    selector:'mode-BomDelopy',
    templateUrl:'./mode-BomDelopy.component.html',
    styleUrls:['./mode-BomDelopy.component.less'],
    providers: [deployService]
})

export class ModeBomDelopyComponent implements OnInit, OnDestroy {
